...
class FromAccount extends Tag
{
    ...
    public static function create(string $institution_name, string $institution_code, string $branch, string $account, string $account_name, string $non_bank_institution = 'true'): static
    {
        return new static($institution_name, $institution_code, $branch, $account, $account_name, $non_bank_institution);
    }

    public function __construct(string $institution_name, string $institution_code, string $branch, string $account, string $account_name, string $non_bank_institution = 'true')
    {
